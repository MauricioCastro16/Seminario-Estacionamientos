...
namespace estacionamientos.Migrations
{
    ...
    [Migration("20250816234928_Valores_por_defecto_en_MetodoPago")]
    partial class Valores_por_defecto_en_MetodoPago
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("estacionamientos.Models.Pago", b =>
                {
                    ...
                    b.Property<int?>("PlayaEstacionamientoPlyID")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PlayaEstacionamientoPlyID");
            ...
            modelBuilder.Entity("estacionamientos.Models.Turno", b =>
                {
                    ...
                    b.Property<DateTime?>("TurApertCaja")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("TurCierrCaja")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("estacionamientos.Models.Pago", b =>
                {
                    ...
                    b.HasOne("estacionamientos.Models.PlayaEstacionamiento", null)
                        .WithMany("Pagos")
                        .HasForeignKey("PlayaEstacionamientoPlyID");
